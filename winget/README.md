...
wingetcreate update omniV1.DayZServerControlCenter `
  --version 1.6.4 `
  --urls https://github.com/omniV1/DayZServer-Expansion-Configs/releases/download/v1.6.4/DayZServerControlCenter-1.6.4-windows.zip `
  --submit
```
...
3. Fork [microsoft/winget-pkgs](https://github.com/microsoft/winget-pkgs), copy the three files from
   `winget/manifests/` to `manifests/o/omniV1/DayZServerControlCenter/1.6.4/` in your fork, and open a
